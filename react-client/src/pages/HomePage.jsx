...
const BookCard = ({ book }) => {
  ...
  return (
    ...
    >
      <Card.Section>
        <Image
          src={book.anhbia ? book.anhbia : 'https://images.unsplash.com/photo-1632986248848-dc72b1ff4621?q=80&w=764&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'}
          height={260}
          fit="cover"
          alt={book.TieuDe}
